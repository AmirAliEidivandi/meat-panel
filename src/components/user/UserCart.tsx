import { Edit, Loader2, RefreshCw, ShoppingCart, Trash2, Truck, X } from "lucide-react";
  ...
  return (
    <div className="fade-in font-vazir max-w-7xl mx-auto">
        ...
        <div className="space-y-4">
          {cart.items.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="flex items-center space-x-reverse space-x-4 p-4 border-2 border-gray-200 rounded-xl hover:border-amber-300 hover:shadow-md transition-all bg-gray-50"
              >
                {/* Product Image */}
                ...
                <div className="flex flex-col items-center space-y-2 min-w-[120px]">
                  <div className="text-center">
                    <p className="text-xs text-gray-600 mb-1">وزن:</p>
                    {isUpdating ? (
                  ...
                  <button
                    ...
                    disabled={isUpdating}
                    className="px-4 py-2 bg-amber-100 hover:bg-amber-200 text-amber-700 rounded-lg transition-colors disabled:opacity-50 font-semibold text-sm flex items-center space-x-reverse space-x-1"
                  >
                ...
                <div className="text-left min-w-[140px]">
                  <p className="text-xs text-gray-600 mb-1">جمع کل:</p>
      ...
      <div className="bg-white rounded-xl border-2 border-gray-200 p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between text-lg p-4 bg-gray-50 rounded-lg">
          ...
          <button
            ...
            className="w-full px-6 py-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-lg hover:from-amber-700 hover:to-orange-700 transition-all font-bold text-lg flex items-center justify-center space-x-reverse space-x-2 shadow-lg"
          >
      ...
      {showCheckoutModal && (
        ...
        >
          <div className="bg-white rounded-xl border-2 border-gray-200 p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900">ثبت درخواست</h2>
              <button
                onClick={() => {
                  setShowCheckoutModal(false);
                  setError("");
          ...
          <div className="bg-white rounded-xl border-2 border-gray-200 p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">کد: {editingItem.product_code}</p>
              </div>
